...
result_bef_M_df[result_bef_M_df['Segment ID'].isin(col_list)] = 0.0  # 전감정 스크립트 0으로 대체
...
result_bef_F_df[result_bef_F_df['Segment ID'].isin(col_list)] = 0  # 전감정 스크립트 0으로 대체
